		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 contact_col">
					<div class="contact_title"><?php echo $nameuser ?> doesn't exists, try with another username</div>
						<button class="contact_button button"> <a href="modify_user.php">Try again<span></span></button>
				</div>
...
$req = $bdd->prepare("UPDATE user 
					SET agenda_link= :agenda, YNagenda= :YNagenda, YNnews= :YNnews, YNweather= :YNweather, YNclock= :YNclock, YNcompliments= :YNcompliments 
					WHERE name='$nameuser'");
$req->execute(array('agenda' => $agenda_link,
					'YNagenda' => $YNagenda,
					'YNnews' => $YNnews,
					'YNweather' => $YNweather,
					'YNclock' => $YNclock,
					'YNcompliments' => $YNcompliments));
?>
	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 contact_col">
					<div class="contact_title">User successfully modified</div>
				</div>
