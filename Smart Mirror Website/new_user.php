			...
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						...
						<div class="section_title">Create your session</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 contact_col">
					<div class="contact_title">Write down your info</div>
					<div class="contact_form_container">

						<form method="post" action="new_user2.php"  id="new_form" class="contact_form">
							<div class="row">
								<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="input_item"><input type="text" name="agenda" class="contact_input trans_200" placeholder="Agenda link" >
									</div>
								</div>
								<button type="button" class="contact_button2 button" data-toggle="modal" data-target="#myModal">How do I get my link?</button>
								    ...
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
								        ...
								        <div class="modal-body">
								          <p>	Open Google Calendar or iCal. <br>
												Click Settings. <br>
												Click the name of the calendar you want to share. <br>
												Click Get shareable link. <br>
												Copy this link to share your calendar.</p>
								        </div>
								...
								<div class="col-lg-6">
									<fieldset>
 										 ...
 										 <div>
    											...
    											<label for="YNagenda">Personnal Calendar</label>
  										</div>
	  									<div>
	  									...
	  									<div>
	    										...
	    										<label for="YNweather">Weather forecast</label>
	  									</div>
	  									<div>
	  									...
	  									<div>
	    										...
	    										<label for="YNcompliments">Notes</label>
	  									</div>
									</fieldset>
								</div>
							</div>
